...
public class ExpandableTextView extends AppCompatTextView {
    ...
    public ExpandableTextView(Context context, AttributeSet attrs) {
        ...
        int resourceIdTrimCollapsedText =
                typedArray.getResourceId(R.styleable.ExpandableTextView_trimCollapsedText, R.string.STR_READ_MORE);
        int resourceIdTrimExpandedText =
                typedArray.getResourceId(R.styleable.ExpandableTextView_trimExpandedText, R.string.STR_READ_LESS);
        ...
        this.colorClickableText = typedArray.getColor(R.styleable.ExpandableTextView_colorClickableText,
                ContextCompat.getColor(context, R.color.text_color_3));
        this.showTrimExpandedText =
                typedArray.getBoolean(R.styleable.ExpandableTextView_showTrimExpandedText, DEFAULT_SHOW_TRIM_EXPANDED_TEXT);
